      ...
      <div className="flex w-96 flex-col gap-2">
        ...
        >
          ...
          <Input
            ...
            radioOptions={Object.values(CARDS).map((type) => ({
              id: type.name,
              label: type.name,
              value: type.name,
            }))}
          />
          <ul className="gap-4">
            {Object.values(CARDS).map((type) => (
              <li className="list-none gap-2" key={type.name}>
                <details className="ml-4">
                  <summary className="text-sm opacity-60">
                    {type.name} variants
                  </summary>
                  <Input
                    key={type.name}
                    ...
                    radioOptions={type.variants.map((variant) => ({
                      id: variant.name,
                      label: variant.name,
                      value: variant.name,
                    }))}
